    ...
    <main className="min-h-screen bg-brand-black text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <section className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-semibold text-white mb-3">3. Servizi offerti</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-white mb-3">4. Prezzi e preventivi</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-white mb-3">5. Responsabilità</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-white mb-3">6. Proprietà intellettuale</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-white mb-3">7. Legge applicabile</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-white mb-3">8. Modifiche</h2>
            <p>
